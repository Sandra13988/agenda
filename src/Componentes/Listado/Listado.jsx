                    ...
                    {contactos.map(contacto => {
                        return (
                            <tr key={contacto.id} >
                                ...
                                <td><Link to={`/detalles/${contacto.id}`}><button onClick={() => onView(contacto.id)} >VER DETALLES</button></Link></td>
                                <td><Link to={`/modificar/${contacto.id}`}><button onClick={() => onUpdate(contacto.id)}> MODIFICAR</button></Link></td>
